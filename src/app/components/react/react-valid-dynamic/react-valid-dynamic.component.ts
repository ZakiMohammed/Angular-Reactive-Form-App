...
@Component({
  selector: 'app-react-valid-dynamic',
  templateUrl: './react-valid-dynamic.component.html',
  styleUrls: ['./react-valid-dynamic.component.css']
})
export class ReactValidDynamicComponent implements OnInit {
